...
with Session(engine) as session:
    ...
    # -------------------------------------------------------------------------
    shipments = [
        Shipment(shipment_id="SHIP-MAPLE-20260301-001",
                 vendor_id="MAPLEWOOD-HARVEST-FARM",
                 shipment_date=datetime(2026, 3, 1,  9,  0, 0, tzinfo=UTC)),
        Shipment(shipment_id="SHIP-CLEAR-20260305-001",
                 vendor_id="CLEARWATER-HARVEST-DAIRY",
                 shipment_date=datetime(2026, 3, 5,  8, 30, 0, tzinfo=UTC)),
        Shipment(shipment_id="SHIP-IRON-20260310-001",
                 vendor_id="IRONWOOD-HARVEST-BUTCHERY",
                 shipment_date=datetime(2026, 3, 10, 11,  0, 0, tzinfo=UTC)),
    ]
    ...
    lots = [
        # Maplewood
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-MAPLE-20260301-001",
                    product_id="PROD-CARROTS",
                    quantity_on_hand=120.250,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 1, 9, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-MAPLE-20260301-001",
                    product_id="PROD-ONIONS",
                    quantity_on_hand=98.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 1, 9, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-MAPLE-20260301-001",
                    product_id="PROD-POTATOES",
        ...
        ShipmentLot(lot_id=uuid.uuid4(),
                    ...
                    quantity_on_hand=90.750,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 1, 9, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-MAPLE-20260301-001",
                    product_id="PROD-BROCCOLI",
                    quantity_on_hand=60.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 1, 9, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
        ...
        ShipmentLot(lot_id=uuid.uuid4(),
                    ...
                    quantity_on_hand=55.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 1, 9, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-MAPLE-20260301-001",
                    product_id="PROD-PEARS",
                    quantity_on_hand=110.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 1, 9, 0, 0, tzinfo=UTC)
                    ),
        ...
        ShipmentLot(lot_id=uuid.uuid4(),
                    ...
                    product_id="PROD-MILK-WHOLE",
                    quantity_on_hand=250.500,
                    unit="l",
                    last_restocked_date=datetime(2026, 3, 5, 8, 30, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-CLEAR-20260305-001",
                    product_id="PROD-MILK-2PCT",
                    quantity_on_hand=180.000,
                    unit="l",
                    last_restocked_date=datetime(2026, 3, 5, 8, 30, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-CLEAR-20260305-001",
                    product_id="PROD-CREAM-35",
        ...
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-CLEAR-20260305-001",
                    product_id="PROD-BUTTER-UNSALTED",
                    quantity_on_hand=75.500,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 5, 8, 30, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-CLEAR-20260305-001",
                    product_id="PROD-CHEESE-CHEDDAR",
                    quantity_on_hand=60.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 5, 8, 30, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-CLEAR-20260305-001",
                    product_id="PROD-CHEESE-MOZZA",
                    quantity_on_hand=45.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 5, 8, 30, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-CLEAR-20260305-001",
                    product_id="PROD-YOGURT-PLAIN",
                    quantity_on_hand=90.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 5, 8, 30, 0, tzinfo=UTC)
                    ),
        ...
        # Ironwood
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-BEEF-GROUND",
                    quantity_on_hand=180.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 10, 11, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-BEEF-STEAK",
                    quantity_on_hand=95.250,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 10, 11, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-CHICKEN-BREAST",
                    quantity_on_hand=110.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 10, 11, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-CHICKEN-THIGH",
                    quantity_on_hand=85.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 10, 11, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-TURKEY-GROUND",
                    quantity_on_hand=70.000,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 10, 11, 0, 0, tzinfo=UTC)
                    ),
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-LAMB-LEG",
        ...
        ShipmentLot(lot_id=uuid.uuid4(),
                    shipment_id="SHIP-IRON-20260310-001",
                    product_id="PROD-PORK-SAUSAGE",
                    quantity_on_hand=65.750,
                    unit="kg",
                    last_restocked_date=datetime(2026, 3, 10, 11, 0, 0, tzinfo=UTC)
                    ),
    ]
